...
const validateToken = async (token, region) => {
    try {
        ...
        console.log('unverifiedHeaders:', unverifiedHeaders);
...
export const handler = async (event, context) => {
    ...
    console.log('validatedDecodedToken:', validatedDecodedToken);
    ...
    policy.allowMethod(AuthPolicy.HttpVerb.GET, `/tasks/${principalId}`)
